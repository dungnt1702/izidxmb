...
class LeaveTypesController extends Controller
{
    ...
    public function index(leave_types_model $leave_types ){
        $a_data = $leave_types->getAllSearch();
        $Data_view['a_leave_types'] = $a_data['a_data'];
        $Data_view['a_search'] = $a_data['a_search'];
        return view('leave_types.index',$Data_view);
    }
    ...
    public function modify(leave_types_model $leave_types, o_request $o_resquest){
        ...
        if($o_resquest->submit)
        {
            ...
            return redirect('leave_types')->with('status', 'Cập nhật dữ liệu thành công!');
        } 

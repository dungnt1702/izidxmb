...
class CreateMergeTimeSheetTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('merge_time_sheet', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->float('workday_reality')->comment = "Ngày công thực tế";
            $table->float('workday_pay')->comment = "Ngày công tính lương";
            $table->float('residue_annual_leave')->comment = "Số phép năm còn lại";

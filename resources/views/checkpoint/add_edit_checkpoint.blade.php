        ...
        <div class="form-group">
            <table class="table table-bordered">
                ...
                @if ($job_id != 2)
                    ...
                    <tr>
                        <th>@if ($job_id == 3) * Đạt 100%-150% chỉ tiêu @else * Đạt trên 91%-120% chỉ tiêu @endif</th>
                        <th>30%</th>
                        <th>1,5</th>
                    ...
                    <tr>
                        <th>@if ($job_id == 3) * Đạt 151% -200% chỉ tiêu @else * Đạt trên 121% -150% chỉ tiêu @endif</th>
                        <th>40%</th>
                        <th>2</th>
                    ...
                    <tr>
                        <th>@if ($job_id == 3) * Đạt 201% chỉ tiêu trở lên @else * Đạt 151% chỉ tiêu trở lên @endif</th>
                        <th>50%</th>
                        <th>2,5</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @if(isset($errorTimeSheet) && count($errorTimeSheet) > 0)
                            @foreach($errorTimeSheet as $key => $val)
                                <tr>
                                    <th scope="row">{{$key}}-{{$month}}-{{$year}}</th>
                                    <td>{{$val}}</td>
                                    <td>@if ($val == 'v') Vắng 1 buổi không phép @elseif ($val == 'v/2') Vắng nửa buổi khôg phép @endif</td>
                                </tr>
                            @endforeach
                        @endif
                        </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @if(isset($errorLate) && count($errorLate)> 0)
                            @foreach($errorLate as $key => $val)
                                @if($key != 'countError')
                                <?php $checkInCheckOut = explode("|",$val)?>
                                <tr>
                                    <th scope="row">{{$key}}-{{$month}}-{{$year}}</th>
                                    <td>{{isset($checkInCheckOut[0]) ? $checkInCheckOut[0] : ''}}</td>
                                    <td>{{isset($checkInCheckOut[1]) ? $checkInCheckOut[1] : ''}}</td>
                                </tr>
                                @endif
                            @endforeach
                        @endif

            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{ Request::root() }}"><i class="fa fa-dashboard fa-fw"></i>Bảng điều khiển</a>
                        </li>
                        <li class="{{ $sz_Class_user }}">
                            <a href="#"><i class="fa fa-user"></i>Quản lý Users<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li class="{{ $sz_User_Index }}"><a class="" href="<?php echo Request::root()."/user"?>">Danh sách Users</a></li>
                                <li><a class="{{ $sz_User_Insert }}" href="<?php echo Request::root()."/user/insert"?>">Thêm users mới</a></li>
                                <li><a class="{{ $sz_User_ListChangeManager }}" href="<?php echo Request::root()."/list-change-manager"?>">Danh sách thay đổi trưởng nhóm</a></li>
                            </ul>
                        </li>

                        <li class="{{ $sz_Class_leaveRequest }}">
                            <a href="#"><i class="fa fa-user-times"></i> Quản lý vắng mặt<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_LeaveRequest_statistic }}" href="<?php echo Request::root()."/leave_request_report"?>">Thống kê vắng mặt trong tháng</a></li>
                                <li><a class="{{ $sz_LeaveRequest_list }}" href="<?php echo Request::root()."/list_leave_request"?>">Đơn vắng mặt cá nhân</a></li>
                                <li><a class="{{ $sz_LeaveRequest_manager }}" href="<?php echo Request::root()."/leave_management"?>">Quản lý kiểm duyệt</a></li>
                                <li><a class="{{ $sz_LeaveRequest_hrm }}" href="<?php echo Request::root()."/hrm_management"?>">Nhân sự kiểm duyệt</a></li>
                                <li><a class="{{ $sz_LeaveRequest_reporter }}" href="<?php echo Request::root()."/reporter_management"?>">Reporter kiểm duyệt</a></li>
                                <li><a class="{{ $sz_LeaveRequest_insert }}" href="<?php echo Request::root()."/leave_request"?>">Đăng ký vắng mặt</a></li>
                            </ul>
                        </li>
                        {{--quan ly over time--}}
                        <li class="">
                            ...
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{$sz_addOverTime}}" href="<?php echo Request::root()."/add_over_time"?>">Đăng ký làm thêm giờ</a></li>
                                <li><a class="{{$sz_MyselfOT}}" href="<?php echo Request::root()."/add_over_myself"?>">Quản lý làm thêm giờ bản thân</a></li>
                                <li><a class="{{$sz_ManagementApproveOT}}" href="<?php echo Request::root()."/management_approve_OT"?>">Quản lý duyệt làm thêm giờ</a></li>
                                <li><a class="{{$sz_HRMApproveOT}}" href="<?php echo Request::root()."/HRM_approve_OT"?>">HRM duyệt làm thêm giờ</a></li>
                                <li><a class="{{$sz_ReporterShowListOT}}" href="<?php echo Request::root()."/Reporter_show_OT"?>">Thống kê làm thêm giờ</a></li>
                            </ul>
                        </li>

                        <li class="{{ $sz_Class_performance }}">
                            <a href="#"><i class="fa fa-sitemap"></i> Hiệu quả làm việc tháng<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_CheckpointByMonth }}" href="<?php echo Request::root()."/checkpoint-by-month"?>">Tự đánh giá</a></li>
                                <li><a class=" {{ $sz_HrmManagerCheckPoint }}" href="<?php echo Request::root()."/hrm-manager-checkpoint"?>">Hrm kiểm duyệt</a></li>
                                <li><a class=" {{ $sz_CensorManagerCheckPoint }}" href="<?php echo Request::root()."/censor-manager-checkpoint"?>">Quản lý kiểm duyệt</a></li>
                                <li><a class=" {{ $sz_ListCheckPoint }}" href="<?php echo Request::root()."/list-checkpoint"?>">Theo dõi bản thân đánh giá</a></li>
                                <li><a class=" {{ $sz_ReportCheckPoint }}" href="<?php echo Request::root()."/report-checkpoint"?>">Tổng hợp đánh giá</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_department }}">
                            <a href="#"><i class="fa fa-sitemap"></i> Quản lý phòng ban<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Department_list }}" href="<?php echo Request::root()."/list_department"?>">Danh sách phòng ban</a></li>
                                <li><a class="{{ $sz_Department_edit }}" href="<?php echo Request::root()."/department/addedit"?>">Thêm mới phòng ban</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_error }}">
                            <a href="#"><i class="fa fa-briefcase"></i> Quản lý vi phạm <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{$sz_Error_list}}" href="<?php echo Request::root()."/error_in_month"?>">Thống kê lỗi vi phạm</a></li>

                            </ul>
                        </li>
                        <li class="{{ $sz_Class_job }}">
                            <a href="#"><i class="fa fa-briefcase"></i> Quản lý nghề nghiệp<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Job_index }}" href="<?php echo Request::root()."/jobs"?>">Danh sách nghề nghiệp</a></li>
                                <li><a class="{{ $sz_Job_modify }}" href="<?php echo Request::root()."/jobs/modify"?>">Thêm mới nghề nghiệp</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_typeRequest }}">
                            <a href="#"><i class="fa fa-file"></i> Quản lý loại nghỉ phép<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_LeaveTypes_index }}" href="<?php echo Request::root()."/leave_types"?>">Danh sách loại nghỉ phép</a></li>
                                <li><a class="{{ $sz_LeaveTypes_modify }}" href="<?php echo Request::root()."/leave_types/modify"?>">Thêm mới loại nghỉ phép</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_position }}">
                            <a href="#"><i class="fa fa-street-view"></i> Quản lý chức vụ<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Position_index }}" href="<?php echo Request::root()."/positions"?>">Danh sách chức vụ</a></li>
                                <li><a class="{{ $sz_Position_modify }}" href="<?php echo Request::root()."/positions/modify"?>">Thêm mới chức vụ</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_group }}">
                            <a href="#"><i class="fa fa-users"></i> Quản lý nhóm<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Group_index }}" href="<?php echo Request::root()."/list_group"?>">Danh sách nhóm</a></li>
                                <li><a class="{{ $sz_Group_modify }}" href="<?php echo Request::root()."/group/addedit"?>">Thêm mới nhóm</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_role }}">
                            <a href="#"><i class="fa fa-lock"></i> Quản lý phân quyền<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Role_index }}" href="<?php echo Request::root()."/list_role_group"?>">Danh sách nhóm quyền</a></li>
                                <li><a class="{{ $sz_Role_insert }}" href="<?php echo Request::root()."/role/insert"?>">Thêm mới nhóm quyền</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_import }}">
                            <a href="#"><i class="fa fa-adjust"></i> Import excel<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Import_index }}" href="<?php echo Request::root()."/import_user"?>">Import user</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_timesheet }}">
                            <a href="#"><i class="fa fa-file-excel-o"></i> Quản lý bảng chấm công<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{ $sz_Timesheet_index }}" href="<?php echo Request::root()."/import_time_sheet"?>">Import file chấm công</a></li>
                                <li><a class="{{$sz_Timesheet_table }}" href="<?php echo Request::root()."/time_sheet/table"?>">Bảng chấm công</a></li>
                            </ul>
                        </li>
                        <li class="{{ $sz_Class_timesheet }}">
                            <a href="#"><i class="fa fa-calendar-check-o"></i> Quản lý bảng công tháng<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level collapse" aria-expanded="false">
                                <li><a class="{{$sz_Timesheet_month}}" href="<?php echo Request::root()."/time_sheet_month"?>">Bảng công tháng</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>

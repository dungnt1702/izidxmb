        ...
        @foreach ($a_data as $a_val)
            ...
            <tr tr_<?php echo $a_val->id ?> class="alert alert-success">
                ...
                <td>
                    ...
                    <button type="button" class="btn-sm btn btn-primary manager-allow {{ $sz_disable }}" <?php if($sz_disable == 'active'){ ?> data-toggle="modal" data-target="#allow" <?php }?> id="confirm_<?php echo $a_val->id ?>">Đồng ý</button>
                    <button type="button" class="btn-sm btn btn-danger manager-reject {{ $sz_disable }}" <?php if($sz_disable == 'active'){ ?> data-toggle="modal" data-target="#reject" <?php }?> id="confirm_<?php echo $a_val->id ?>">Từ chối</button>

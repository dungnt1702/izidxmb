...
@section('content')
    ...
    <form method="get" action="" id="frmFilter" name="frmFilter"  class="form-inline">
        ...
        <div class="form-group">
            ...
            <a class="btn btn-primary btn-sm" href="/convert_over_time_report" target="_blank">Merge OT</a>
            <a class="btn btn-primary btn-sm" href="/export_excel_OT" target="_blank">Export Excel</a>
    ...
    <table class="table table-responsive table-hover table-striped table-bordered">
        ...
        <tr>
            ...
            @foreach ($a_Data['a_RangeDate'] as $i_Date)
                <td class="td_report">
                    {{$o_Timesheet->$i_Date}}
                </td>
            @endforeach

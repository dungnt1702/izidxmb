        ...
        <tr>
            ...
            <?php if(in_array($a_Role[Auth::user()->role_id], array('superadmin','reporter 1','reporter 2'))) { ?>
                <td>
                    ...
                    <a id="trash_switch_" href="javascript:GLOBAL_JS.v_fDelRow({{ $user->id }},1)" title="Cho vào thùng rác" class="not-underline">
                    <i class="fa fa-trash fa-fw text-danger"></i>
                    </a>
                    <?php }else{ ?>
                    <a title="Khôi phục user" href="javascript:GLOBAL_JS.v_fRecoverRow({{ $user->id }})"  title="Edit" class="not-underline">
                        <i class="fa fa-upload fw"></i>
                    </a>
                    <a id="trash_switch_" href="javascript:GLOBAL_JS.v_fDelRow({{ $user->id }},2)" title="Xóa vĩnh viễn" class="not-underline">

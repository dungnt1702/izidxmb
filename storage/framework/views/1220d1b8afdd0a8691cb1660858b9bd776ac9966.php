...
<h3 class="col-xs-12 no-padding">Danh sách nhóm</h3>
<form method="get" action="" id="frmFilter" name="frmFilter"  class="form-inline">
    ...
    <div class="form-group">
        <input id="search_field" name="search_field" type="text" class="form-control input-sm" placeholder="Nhập tên nhóm" value="<?php echo isset($a_search['search_field'])?$a_search['search_field']:''?>">
    </div>
    <div class="form-group">
        ...
        <?php foreach($a_Group as $a_val): ?>
            <tr>
                ...
                <td>                    
                    ...
                    ?>
                    <a title="Edit" href="<?php echo Request::root().'/group/addedit?id='.$a_val->id;?>" title="Edit" class="not-underline">
...
<!--Hidden input-->
<input type="hidden" name="tbl" id="tbl" value="groups">
    <?php echo $a_Group->links(); ?>

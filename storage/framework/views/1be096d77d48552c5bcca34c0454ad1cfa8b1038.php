    ...
    ?>
        <div class="col-md-12 no-padding">
            <div>
                ...
                <div class="col-md-12 no-padding">
                        <div class="col-md-12 no-padding">
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_LeaveRequest_insert); ?>">
                                <table>
                                    <tr>
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_user); ?>">
                                <table>
                                    <tr>
                                        <th class="text-center">
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_leaveRequest); ?>">
                                <table>
                                    <tr>
                                        <th class="text-center">
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_department); ?>">
                                <table>
                                    <tr>                 
                                        <th class="text-center">
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_job); ?>">
                                <table>
                                    <tr>                 
                                        <th class="text-center">
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_typeRequest); ?>">
                                <table>
                                    <tr>                 
                                        <th class="text-center">
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_position); ?>">
                                <table>
                                    <tr>                 
                                        <th class="text-center">
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Class_group); ?>">
                                <table>
                                    <tr>                 
                                        <th class="text-center">
                            ...
                            <?php if(Auth::user()->role_id == config('cmconst.id_superadmin')): ?>
                            ...
                            <div class="col-xs-1 col-md-1 col-lg-1 home-index-mobille home-index-pc <?php echo e($sz_Import_index); ?>">
                                <table>
                                    <tr>                 
                                        <th class="text-center">

...
<input type="submit" class="btn-sm btn btn-primary check-check-all" name="allow_all" value="Duyệt nhiều" onclick="return confirm('Bạn có chắc chắn muốn đồng ý các phiếu đánh giá này?')" />
    ...
    <?php foreach($a_checkpoints as $key => $o_checkpoint): ?>
        ...
        <tr id="tr_<?php echo $o_checkpoint->id ?>">
            ...
            <td>    <?php echo e($a_Users[$o_checkpoint->user_id]['code']); ?></td>
            <td>    <?php echo e($a_Users[$o_checkpoint->user_id]['name']); ?></td>
            <td>    <?php echo e($a_Users[$o_checkpoint->user_id]['email']); ?></td>
            <td>    <?php echo e($a_Users[$o_checkpoint->user_id]['department']); ?></td>
            <td>    <?php echo e($a_Users[$o_checkpoint->user_id]['position']); ?></td>

...
<h3 class="col-xs-12 no-padding">Thay đổi Người quản lý trực tiếp</h3>
    <form class="form-horizontal" method="post" action="">
        ...
        <div class="form-group"> 
            <div class="col-xs-12 col-sm-6 no-padding">
                <label for="" class="col-xs-12 col-sm-4 control-label text-left">Phòng ban mới</label>
        ...
        <div class="form-group"> 
            <div class="col-xs-12 col-sm-6 no-padding">
                <label for="" class="col-xs-12 col-sm-4 control-label text-left">Quản lý trực tiếp mới</label>
                <div class="col-xs-12 col-sm-8 no-padding">

    ...
    <div class="">
        ...
        <?php foreach($a_data as $a_val): ?>
            ...
            <tr tr_<?php echo $a_val->id ?> class="alert alert-success">
                ...
                <td>    <?php echo e($a_val->email); ?></td>
                <td>    <?php echo e($a_val->leave_type_name); ?></td>
                <td>    <?php echo e($a_val->user_comment); ?></td>
                <td>    <?php echo e($a_val->status_name); ?></td>
                <td>    <?php echo $a_val->time?></td>
                <td>    <?php echo e($a_val->created_at); ?></td>
                <td>
                    <?php if($a_val->status == 0) { ?>
                    <button type="button" class="btn-sm btn btn-primary manager-allow <?php echo e($sz_disable); ?>" <?php if($sz_disable == 'active'){ ?> data-toggle="modal" data-target="#allow" <?php }?> id="confirm_<?php echo $a_val->id ?>">Đồng ý</button>
                    <button type="button" class="btn-sm btn btn-danger manager-reject <?php echo e($sz_disable); ?>" <?php if($sz_disable == 'active'){ ?> data-toggle="modal" data-target="#reject" <?php }?> id="confirm_<?php echo $a_val->id ?>">Từ chối</button>

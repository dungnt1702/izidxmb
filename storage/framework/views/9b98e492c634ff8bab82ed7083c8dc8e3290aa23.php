...
<form method="get" action="" id="frmFilter" name="frmFilter"  class="form-inline">
    ...
    <div class="form-group">
        <input id="search_field" name="search_field" type="text" class="form-control input-sm" placeholder="Nhập tên phòng ban" value="<?php echo isset($a_search['search_field'])?$a_search['search_field']:''?>">
    </div>
    <div class="form-group">
    ...
    <div class="">
        ...
        <?php foreach($a_Department as $a_val): ?>
            <tr>

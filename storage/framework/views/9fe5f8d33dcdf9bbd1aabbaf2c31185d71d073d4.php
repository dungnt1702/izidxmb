...
<form method="get" action="" id="frmFilter" name="frmFilter"  class="form-inline">
    ...
    <?php foreach($a_jobs as $key => $o_job): ?>
        ...
        <tr>
            ...
            <td>    <?php echo e($o_job->created_at); ?></td>
            <td>    <?php echo e($o_job->updated_at); ?></td>
            <td>                    
                <?php
                ...
                <a id="trash_switch_" href="javascript:GLOBAL_JS.v_fDelRow(<?php echo e($o_job->id); ?>,1)" title="Cho vào thùng rác" class="not-underline">
                <i class="fa fa-trash fa-fw text-danger"></i>
                </a>
                <?php }else{ ?>
                <a title="Khôi phục user" href="javascript:GLOBAL_JS.v_fRecoverRow(<?php echo e($o_job->id); ?>)"  title="Edit" class="not-underline">
                    <i class="fa fa-upload fw"></i>
                </a>
                <a id="trash_switch_" href="javascript:GLOBAL_JS.v_fDelRow(<?php echo e($o_job->id); ?>,2)" title="Xóa vĩnh viễn" class="not-underline">

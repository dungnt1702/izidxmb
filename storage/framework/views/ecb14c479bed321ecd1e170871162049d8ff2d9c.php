...
<body id="app-layout">
            ...
            <div class="collapse navbar-collapse" id="spark-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(!Auth::guest()): ?>
                        ...
                        <li class="dropdown">
                            <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <span class="header_color">Hotline support: <span class="hotline-support"><b>0163.529.3626 - 0988.621.707</b></span></span>
                            </a>
                        </li>
                        <li class="dropdown">
    ...
    <!--End pop-up-->
            ...
            <?php
                ...
                $sz_Class_user = $sz_Class_leaveRequest = $sz_Class_department = $sz_Class_job = $sz_Class_typeRequest = $sz_Class_position = $sz_Class_group =
                $sz_Class_role = $sz_Class_import = $sz_Class_timesheet = "hidden";
